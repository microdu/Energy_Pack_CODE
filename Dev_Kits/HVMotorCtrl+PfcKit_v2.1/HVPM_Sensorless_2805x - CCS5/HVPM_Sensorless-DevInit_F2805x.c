//============================================================================
// FILE:	HVACI_Sensored-DevInit_F2805x.c
// TITLE:	Device initialization for F2805x series
//============================================================================
...
//--------------------------------------------------------------------------------------
//  GPIO-12 - PIN FUNCTION = CTRIPM1OUT
	GpioCtrlRegs.GPAMUX1.bit.GPIO12 = 3;	// 0=GPIO,  1=TZ1n (I)/CTRIPM1OUT,  2=SCITX-A,  3=CTRIPM1OUT
...
//  GPIO-15 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX1.bit.GPIO15 = 1;	// 0=GPIO,  1=TZ1,  2=LINRX-A,  3=SPISTE-B
