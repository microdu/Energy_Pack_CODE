...
//============================================================================
//
// FILE:	HVPMSM_Sensored_Servo-DevInit_F2803x.c
//
...
// LOW SPEED CLOCKS prescale register settings
   SysCtrlRegs.LOSPCP.all = 0x0003;		// Sysclk / 6 (10 MHz)
...
//  GPIO-19 - PIN FUNCTION = --Spare--
	GpioCtrlRegs.GPAMUX2.bit.GPIO19 = 1;	// 0=GPIO,  1=SPISTE-A,  2=LINRX-A,  3=ECAP1  //ramesh - xclk
