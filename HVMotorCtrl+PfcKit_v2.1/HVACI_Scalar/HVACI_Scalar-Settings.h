...
------------------------------------------------------------------------------*/
#define LEVEL1  1      		// Module check out, duty cycle waveforms 
#define LEVEL2  2           // Verify PWM signal generation, rotor speed, and output voltage 
#define LEVEL3  3           // PID regulator, closed loop Scalar control 
