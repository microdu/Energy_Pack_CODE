...
// Checkin $Date: August 31, 2011   16:33:02 $
//###########################################################################
//
// FILE:    2805x_RAM_lnk.cmd
//
// TITLE:   Linker Command File For 2805x examples that run out of RAM
//
//          This ONLY includes all SARAM blocks on the 2805x device.
...
//
//###########################################################################
// $TI Release: 2805x Internal Release 2 $
...
PAGE 0 :
   ...
   progRAM         : origin = 0x008800, length = 0x001200
...
/*   IQMATH   	 	: origin = 0x3FE7D8, length = 0x000AFA
   BOOTROM       	: origin = 0x3FF2D2, length = 0x000500		*/
...
PAGE 1 :
   ...
   RAML3           : origin = 0x009A00, length = 0x000600
}
