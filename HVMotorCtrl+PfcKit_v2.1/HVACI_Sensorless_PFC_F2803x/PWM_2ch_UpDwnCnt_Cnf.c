...
void PWM_2ch_UpDwnCnt_CNF(int16 n, Uint16 period, int16 mode, int16 phase) {
	...
	(*ePWM[n]).CMPA.half.CMPA = 0;			// set duty 50% initially
	...
	// Counter Compare Submodule Registers
	(*ePWM[n]).CMPB = 0;						// set duty 50% initially
